...
Plugin URI: http://warting.se/wordpress-guest-post-plugin/
Description: Review posts submitted by the users to approval...
Author: Stefan Wärting - Original plugin: Lisa Angelettie
Version: 1.0
Author URI: http://warting.se/wordpress-guest-post-plugin/
*/
...
wp_enqueue_script('postreviewbyadmin_script',plugins_url( 'js/postreviewbyadmin_script.js' , __FILE__ ));
				...
				<div style="float:left; width:580px;">
					<div style="float:left;width:175px;"><p>Title Of Article : </p></div>
						<div style="float:left;width:400px;">
							<p><input type="text" id="title" class="txtbg" value="<?php echo $unapost[0]["post_title"]; ?>" size="30" name="post_title" style="width:90%;"><br /><span class="hint">(100 characters max)</span></p>
						</div>
					</div>
					<div style="float:left; width:580px;">
                  ...
                  <span class="hint">(2-5 sentences, no paragraphs please)</span></p>
					...
					<div style="float:left; width:580px;">
						<div style="float:left;width:450px;">
							<p><input type="submit" value="Approve Post" class="button-primary" id="submit" name="submit"></p>
						</div>
					</div>
				</div>
			</form>
...
<?php 			
					...
					foreach($getpostdetails as $hh)	{
						$approve_link = esc_url( "admin.php?page=wordpress-guest-post/wordpressguestpost.php&sns_reviewposts_view=approve&sns_reviewposts_id=" . $hh->ID );
						$disapprove_link = esc_url( "admin.php?page=wordpress-guest-post/wordpressguestpost.php&sns_reviewposts_view=disapprove&sns_reviewposts_id=" . $hh->ID );
						echo "<tr id=\"search-{$hh->ID}\" class=\"$class\">";
						echo "<td>". $hh->ID."</td>\n";
						echo "<td>". $hh->post_title."</td>\n";
						echo "<td>". $hh->post_author_name."</td>\n";
						echo "<td>". $hh->post_date."</td>\n";
						echo '<td><a class="view" href='.$approve_link.'>Approve</a></td>';
						echo '<td><a class="view" href='.$disapprove_link.'>Disapprove</a></td>';
						echo "</tr>";
	...
	<form id="frmsettings" name="frmsettings" method="post" action="" enctype="multipart/form-data">
		<div style="float:left;margin: 5px 0 15px;">
			...
			<div style="float:left;width:580px;"><div style="float:left;width:450px;"><p>&nbsp;</p></div></div>
				<div style="float:left; width:580px;">
					<div style="float:left;width:450px;">
						<p><input type="submit" value="Save Settings" id="submit" class="button-primary"  name="submit" ></p>
					</div>
				</div>
			</div>
		</form>
	...
	<form id="frmaddpost" name="frmaddpost" method="post" action="" enctype="multipart/form-data">
		<div class="addpostmaindiv">
			...
			<div class="addpostinnerdiv">
				...
				<div class="addpostctrl">
					<p><textarea id="post_content" name="post_content" class="txtareabgcont" cols="40" rows="20" style="width: 90%" onkeyup="limiter()"><?php echo $_POST['post_content']; ?></textarea>
					</p>
                	<p>
			...
			<div class="addpostinnerdiv">
				...
				<div class="addpostctrl">
					<p><img id="captcha" src="<?php echo plugins_url( 'securimage/securimage_show.php' , __FILE__ ); ?>" alt="CAPTCHA Image" border="0" /></p>
				</div>
			</div>
...
<a href="#" onclick="document.getElementById('captcha').src = '<?php echo plugins_url( 'securimage/securimage_show.php' , __FILE__ ); ?>?' + Math.random(); return false">[ Different Image ]</a>					
					</p>
				</div>
			</div>
			...
			<div class="addpostinnerdiv">
				...
				<div class="addpostctrl">
					<p>
						<input type="submit" value="Submit Article" id="submit" name="submit" class="button-primary" >&nbsp;
						<input type="submit" id="Preview" name="Preview"  value="Preview" class="button-primary" >
					</p>
				</div>
			</div>
		</div>
